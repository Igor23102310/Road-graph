#! /usr/bin/env python
# -*- coding: cp1251 -*-
"""аблон длЯ созадниЯ модулей
        длЯ Python3"""

#-------------------------------------------------------------------------------
# Name:        ‚ведите название модулЯ
#
# Author:
#
# Created:     15.02.2017
# Copyright:   (c) Љафедра геоинформатики и кадастра ЌЌѓЂ‘“ 2017
#-------------------------------------------------------------------------------
...
def main():
    ...
    FileName="‚ыгруженные маршруты в файле MIF и MID/5routes.mif"
    print("Њаршрут 1")
    a=[]
    route=934,1476
